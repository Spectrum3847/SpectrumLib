...
public class SpectrumPreferences {
	...
	/**
	 * Returns the string at the given key. If this table does not have a value for
	 * that position,
	...
	/**
	 * Returns the number at the given key. If this table does not have a value for
	 * that position,
	 * then the given backup value will be returned.
	 *
	 * @param key    the key
