...
public class GeomUtil {
     ...
     * @param t The scale factor, 0 {@literal <}= t {@literal <}= 1
     * @return "The pose which represents the interpolation. For t {@literal <}= 0, the lhs
     *     parameter is returned directly. For t {@literal >}= 1, the "rhs" parameter is returned
     *     directly."
     */
