...
/**
 * This class maps the value of a stick input to a spline curve. It is a
 * subclass of <code>Curve</code>.
 * 
 * For <code>LINEAR</code> curves, the points provided represent the vertecies
